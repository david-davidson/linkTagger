...
printf "Paste in existing GLT, write new GLT, or just check link formatting?\nEnter e for existing, n for new, or f for formatting:\n" # Formatting mode just makes sure that all section IDs are at the very end of URLs and, if you want, adds target="_blank"
read MODE
if [[ "$MODE" = "e" || "$MODE" = "E" ]]
	then
		echo "Right-click and paste in your GLT:"
		read GLT
